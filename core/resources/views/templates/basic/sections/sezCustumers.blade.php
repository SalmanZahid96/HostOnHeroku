    ...
    <div class="container">
        ...
        <div class="row justify-content-center">
            <div class="col-lg-8 text-center">
                <div class="section-header">
                    ...
                    <h2 class="section-title" style="color: #031c6c;">Sez Is For </h2>
        ...
        <div onclick="location.href='#';" style="cursor: pointer;" class="col-lg-4 col-md-6 col-sm-8 mrb-30">
                    <div class="service-item text-center">
                        ...
                        <i class="las la-tag"></i>                     </div>
                        <div class="service-content">
                            <h3 class="title">Brands </h3>
                        </div>
                    </div>
                </div>
        <div onclick="location.href='https://www.instagram.com/sez.market/';" style="cursor: pointer;" class="col-lg-4 col-md-6 col-sm-8 mrb-30">
                    ...
                    <div class="service-item text-center">
                        ...
                        <div class="service-icon">
                        <i class="las la-store-alt"></i>  </div>
                        <div class="service-content">
                ...
                <div onclick="location.href='https://www.facebook.com/SezOfficiel';" style="cursor: pointer;"  class="col-lg-4 col-md-6 col-sm-8 mrb-30">
                    <div class="service-item text-center">
                        <div class="service-shape">
                            <img src="assets/templates/basic/images/shape-3.png" alt="shape">
                        </div>
                        <div class="service-icon">
                        <i class="las la-suitcase"></i>                    </div>
                        <div class="service-content">
                            <h3 class="title">Services & events </h3>
