            ...
            <div class="row justify-content-center align-items-center ml-b-30">
                ...
                <div class="col-lg-6 mrb-30">
                    <div class="register-form-area">
                        ...
                        <form class="register-form" method="post" action="{{url('contact.send')}}">
                            @csrf
                            ...
                            <div class="row justify-content-center ml-b-20">
                                ...
                                <div class="col-lg-12 form-group">
                                    <input name="subject" type="text" placeholder="@lang('Write your business')" value="{{old('subject')}}" required>
                                </div>
                                <div class="col-lg-12 form-group">
                                    <textarea name="message" wrap="off" placeholder="@lang('Write a description on what your business is')">{{old('message')}}</textarea>
                                </div>
